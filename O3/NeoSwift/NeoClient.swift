...
public class NeoClient {
    ...
    public func getBestBlockHash(completion: @escaping (NeoClientResult<String>) -> Void) {
    ...
    public func getBlockBy(hash: String, completion: @escaping (NeoClientResult<Block>) -> Void) {
    ...
    public func getBlockBy(index: Int64, completion: @escaping (NeoClientResult<Block>) -> Void) {
    ...
    public func getPeers(completion:  @escaping (NeoClientResult<GetPeersResult>) -> Void) {
    ...
    public func getBlockHash(for index: Int64, completion: @escaping (NeoClientResult<String>) -> Void) {
    ...
    public func getTransaction(for hash: String, completion: @escaping (NeoClientResult<Transaction>) -> Void) {
    ...
    public func getTransactionOutput(with hash: String, and index: Int64, completion: @escaping (NeoClientResult<ValueOut>) -> Void) {
    ...
    public func getUnconfirmedTransactions(completion: @escaping (NeoClientResult<[String]>) -> Void) {
    ...
    public func getClaims(address: String, completion: @escaping(NeoClientResult<Claimable>) -> Void) {
        ...
        sendFullNodeRequest(url, params: nil) { result in
            ...
            case .success(let response):
                ...
                guard let result = try? JSONSerialization.data(withJSONObject: response["result"], options: .prettyPrinted),
    ...
    public func getTransactionHistory(for address: String, completion: @escaping (NeoClientResult<TransactionHistory>) -> Void) {
    ...
    public func validateAddress(_ address: String, completion: @escaping(NeoClientResult<Bool>) -> Void) {
    ...
    public func getTokenInfo(with scriptHash: String, completion: @escaping(NeoClientResult<NEP5Token>) -> Void) {
    ...
    public func getAssetState(for asset: String, completion: @escaping(NeoClientResult<AssetState>) -> Void) {
