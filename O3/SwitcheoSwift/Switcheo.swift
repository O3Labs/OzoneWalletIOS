...
public class Switcheo {
    ...
    public enum V3: String {
        case Main = "a32bcf5d7082f740a4007b16e812cf66a457c3d4"
        case Test = "aff38ca20ef96a7b86618d86f1bd3879db78c8bb"
    }
    ...
    func sendRequest<T>(ofType _: T.Type,_ endpointURL: String, method: HTTPMethod, data: JSONDictionary, completion: @escaping (SWTHResult<T>) -> Void){
        ...
        request.setValue("o3-api", forHTTPHeaderField: "X-Referral-Source")
